...
docker run --name myapp1 -p 8888:8080 -d haseebk8s/retail-store-sample-ui:1.0.0
...
# Example with 'haseebk8s':
docker tag retail-store-sample-ui:2.0.0 haseebk8s/retail-store-sample-ui:2.0.0

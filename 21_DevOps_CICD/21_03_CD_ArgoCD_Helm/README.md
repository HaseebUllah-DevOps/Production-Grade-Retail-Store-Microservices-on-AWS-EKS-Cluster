...
> In this demo, the repository [aws-devops-github-actions-ecr-argocd3](https://github.com/HaseebUllah-DevOps/aws-devops-github-actions-ecr-argocd3/) will be made public by the time you're implementing it, so authentication won’t be required in most cases.
...
argocd repo add https://github.com/HaseebUllah-DevOps/aws-devops-github-actions-ecr-argocd3.git 
...
spec:
  project: default
  source:
    repoURL: https://github.com/HaseebUllah-DevOps/aws-devops-github-actions-ecr-argocd3.git
    targetRevision: main
    path: src/ui/chart
    helm:
      valueFiles:

...
> **Pricing Note:** All prices in this document are approximate values from **AWS us-east-1 (N. Virginia) region** as of **April 2026**. Prices may vary slightly over time.

### Why Real AWS Resources?

This Project uses **real AWS infrastructure** because:
...
1. **  (84%) runs on **t3.small nodes** - the most cost-efficient option.

2. Only the final **16%** (OpenTelemetry and CI/CD sections) require t3.large nodes.
...
> **Note:** All prices below are approximate values from AWS us-east-1 region as of April 2026.
...
**Remember:** This is an investment in your career. The cost of this Project (content + AWS) is a fraction of what you will earn with these skills.
...
*All prices are approximate values from AWS us-east-1 (N. Virginia) region as of April 2026. Actual costs may vary slightly. Always monitor your AWS billing dashboard and verify current pricing in AWS console.*
